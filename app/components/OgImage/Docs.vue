...
<template>
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    ...
    <div class="w-[700px] pl-[100px]">
      <p v-if="headline" class="uppercase text-[24px] text-[#ECDC5A] mb-4 font-semibold">
        {{ headline }}
      </p>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" 
      class="absolute top-[280px] right-[225px] text-white"
      width="80"
      height="80">
      <g>
        <path d="M176,384H16c-8.832,0-16,7.168-16,16c0,8.832,7.168,16,16,16h160c8.832,0,16,7.2,16,16s-7.168,16-16,16 c-8.832,0-16,7.168-16,16c0,8.832,7.168,16,16,16c26.464,0,48-21.536,48-48S202.464,384,176,384z" fill="currentColor" />
      </g>
      <g>
        <path d="M240,256c-8.832,0-16,7.168-16,16c0,8.832,7.168,16,16,16c8.832,0,16,7.2,16,16s-7.168,16-16,16H16 c-8.832,0-16,7.168-16,16c0,8.832,7.168,16,16,16h224c26.464,0,48-21.536,48-48S266.464,256,240,256z" fill="currentColor" />
      </g>
      <g>
        <path d="M288,32C164.288,32,64,132.288,64,256c0,10.88,1.056,21.536,2.56,32h128.192c-1.792-4.992-2.752-10.4-2.752-16 c0-26.464,21.536-48,48-48c44.096,0,80,35.904,80,80c0,44.128-35.904,80-80,80h-0.416C249.76,397.408,256,413.92,256,432 c0,16.032-4.864,30.944-13.024,43.456c14.56,2.976,29.6,4.544,45.024,4.544c123.712,0,224-100.288,224-224S411.712,32,288,32z" fill="currentColor" />
      </g>
    </svg>
