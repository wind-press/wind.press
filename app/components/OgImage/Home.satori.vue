  ...
  <div class="w-full h-full flex flex-col justify-center bg-[#020420]">
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur stdDeviation="40.5" result="effect1_foregroundBlur_home" />
        </filter>
      </defs>
    </svg>
    ...
    <div class="w-[800px] pl-[100px]">
      <div class="flex items-center gap-[20px] mb-[40px]">
        <div class="w-[64px] h-[64px] rounded-[14px] bg-[#4e6fc3] flex items-center justify-center">
          <svg width="40" height="40" viewBox="0 0 512 512" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <span style="font-size: 36px; font-weight: 600; color: white;">Yabe Webfont</span>
      </div>

      <h1 class="m-0 text-[68px] font-semibold mb-[20px] text-white leading-tight">
        {{ title }}
      </h1>
