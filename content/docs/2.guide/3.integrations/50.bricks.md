...
![Enable or disable the features](/assets/docs/guide/integrations/bricks/screenshot-1.webp){width="1440px" height="866px"}
...
![Plain Classes input field](/assets/docs/guide/integrations/bricks/screenshot-2.webp){width="1440px" height="866px"}
...
![Autocomplete class names](/assets/docs/guide/integrations/bricks/screenshot-3.webp){width="1440px" height="866px"}
...
![Class Sorting](/assets/docs/guide/integrations/bricks/screenshot-4.webp){width="1440px" height="866px"}
...
![Hover Preview the generated css for the class](/assets/docs/guide/integrations/bricks/screenshot-5.webp){width="1440px" height="866px"}
...
![Variable Picker](/assets/docs/guide/integrations/bricks/screenshot-6.webp){width="3424px" height="1944px"}
...
![Paste HTML code into the Bricks editor](/assets/docs/guide/integrations/bricks/screenshot-7.webp){width="3424px" height="1944px"}
