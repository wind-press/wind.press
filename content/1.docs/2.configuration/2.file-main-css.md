...
![The `main.css` file editor](/img/docs/content/configuration/file-main-css/screenshot-1.png){width="1440px" height="866px"}
...
![Uncommented `@import 'tailwindcss/preflight.css' layer(base);` line](/img/docs/content/configuration/file-main-css/screenshot-3.png){width="1440px" height="866px"}
...
![Importing additional CSS files](/img/docs/content/configuration/file-main-css/screenshot-2.png){width="1440px" height="866px"}
